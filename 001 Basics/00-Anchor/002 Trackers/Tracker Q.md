...
const SURAH_PAGES = [
  1.0, 2.0, 50.0, 77.0, 106.0, 128.0, 151.0, 177.0, 187.0, 208.0, 221.0, 235.0, 249.0, 
  255.0, 262.0, 267.0, 282.0, 293.0, 305.0, 312.0, 322.0, 332.0, 342.0, 350.0, 359.0, 
  367.0, 377.0, 385.0, 396.0, 404.0, 411.0, 415.0, 418.0, 428.0, 434.0, 440.0, 446.0, 
  453.0, 458.0, 467.0, 477.0, 483.0, 489.0, 496.0, 499.0, 502.0, 507.0, 511.0, 515.0, 
  518.0, 520.0, 523.0, 526.0, 528.0, 531.0, 534.0, 537.0, 542.0, 545.0, 549.0, 551.0, 
  553.0, 554.0, 556.0, 558.0, 560.0, 562.0, 564.0, 566.0, 568.0, 570.0, 572.0, 574.0, 
  575.0, 577.0, 578.0, 580.0, 582.0, 583.0, 585.0, 586.0, 587.0, 587.6, 589.0, 590.0, 
  591.0, 591.6, 592.0, 592.6, 593.0, 595.0, 595.6, 596.0, 596.5, 597.0, 597.4, 598.0, 
  598.4, 599.0, 599.5, 600.0, 600.6, 601.0, 601.4, 601.7, 602.0, 602.4, 602.7, 603.0, 
  603.4, 603.7, 604.0, 604.4, 604.7
];
...
const renderActualModal = async (LAST_INPUT_KEY) => {
  ...
  const calcPages = () => {
    ...
    if (!isNaN(start) && !isNaN(end) && end >= start) {
      mode2Result.innerText = `المجموع: ${end - start + 1} صفحة`;
    } else {
