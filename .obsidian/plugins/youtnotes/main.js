...
let l = require(`obsidian`),
  u = require(`@codemirror/state`),
  d = require(`@codemirror/view`);
var f = {
    autoplayOnNoteSelect: !1,
    singleExpandMode: !0,
    newLineTrigger: `shift+enter`,
    persistExpandedState: !1,
    openExportedFile: !0,
    showNoteStats: !0,
    pinOnPhone: !1,
  },
  p = class extends l.PluginSettingTab {
    ...
    display() {
      ...
      e.empty();
      let t = async () => {
        (await this.plugin.saveDataState(), this.plugin.refreshAllViews());
      };
      ...
      let n = (n, r, i) => {
        new l.Setting(e)
          ...
          .setDesc(r)
          .addToggle((e) =>
            e.setValue(this.plugin.settings[i]).onChange(async (e) => {
              ((this.plugin.settings[i] = e), await t());
            }),
          );
      };
      (n(
        ...
        new l.Setting(e)
          ...
          .addDropdown((e) =>
            e
              ...
              .onChange(async (e) => {
                ((this.plugin.settings.newLineTrigger = e), await t());
              }),
          ),
        n(
...
function A(e, t, n) {
  ...
  if (
    (arguments.length > 2 &&
      (o.children = arguments.length > 3 ? m.call(arguments, 2) : n),
...
function fe(e) {
  ((!e.__d && (e.__d = !0) && _.push(e) && !pe.__r++) ||
    v != h.debounceRendering) &&
    ((v = h.debounceRendering) || y)(pe);
}
function pe() {
  try {
    for (var e, t = 1; _.length; )
      (_.length > t && _.sort(b), (e = _.shift()), (t = _.length), ue(e));
  } finally {
    _.length = pe.__r = 0;
  }
}
function me(e, t, n, r, i, a, o, s, c, l, u) {
  var d,
    ...
    v = (r && r.__k) || ne,
    y = t.length;
  for (c = he(n, t, v, c, y), d = 0; d < y; d++)
    (p = n.__k[d]) != null &&
      ((f = (p.__i != -1 && v[p.__i]) || te),
      (p.__i = d),
      (g = Se(e, p, f, i, a, o, s, c, l, u)),
      (m = p.__e),
      p.ref &&
        f.ref != p.ref &&
        (f.ref && De(f.ref, null, p), u.push(p.ref, p.__c || m, p)),
      h == null && m != null && (h = m),
      (_ = !!(4 & p.__u)) || f.__k === p.__k
        ? ((c = ge(p, c, e, _)), _ && f.__e && (f.__e = null))
    ...
    (o = t[a]) != null && typeof o != `boolean` && typeof o != `function`
      ? (typeof o == `string` ||
        ...
        o.constructor == String
          ? (o = e.__k[a] = ae(null, o, null, null, null))
          : O(o)
            ? (o = e.__k[a] = ae(se, { children: o }, null, null, null))
            : o.constructor === void 0 && o.__b > 0
              ? (o = e.__k[a] =
                  ae(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v))
              : (e.__k[a] = o),
        (c = a + f),
        (o.__ = e),
        (o.__b = e.__b + 1),
        (s = null),
        (l = o.__i = ve(o, n, c, d)) != -1 && (d--, (s = n[l]) && (s.__u |= 2)),
        s == null || s.__v == null
          ? (l == -1 && (i > u ? f-- : i < u && f++),
...
function ge(e, t, n, r) {
  ...
  if (typeof e.type == `function`) {
    for (i = e.__k, a = 0; i && a < i.length; a++)
      i[a] && ((i[a].__ = e), (t = ge(i[a], t, n, r)));
    return t;
  }
  e.__e != t &&
    (r &&
      (t && e.type && !t.parentNode && (t = le(e)),
...
function ye(e, t, n) {
  t[0] == `-`
    ? e.setProperty(t, n ?? ``)
    : (e[t] =
        n == null ? `` : typeof n != `number` || re.test(t) ? n : n + `px`);
}
  ...
  n: if (t == `style`)
    ...
    ((a = t != (t = t.replace(w, `$1`))),
      ...
      n
        ? r
          ? (n[C] = r[C])
          : ((n[C] = T), e.addEventListener(t, a ? ee : E, a))
        : e.removeEventListener(t, a ? ee : E, a));
  else {
  ...
  n: if (typeof E == `function`)
    try {
      if (
        ...
        (b = (u = E.contextType) && r[u.__c]),
        (x = u ? (b ? b.props.value : u.__) : r),
        n.__c
          ...
          : (y
            ...
            (d.__h = []),
            (d._sb = [])),
        y && d.__s == null && (d.__s = d.state),
        y &&
          E.getDerivedStateFromProps != null &&
          (d.__s == d.state && (d.__s = k({}, d.__s)),
          k(d.__s, E.getDerivedStateFromProps(v, d.__s))),
        (p = d.props),
        (m = d.state),
        (d.__v = t),
        f)
        ...
        (y &&
          ...
          y && d.componentDidMount != null && d.__h.push(d.componentDidMount));
      else {
        if (
          (y &&
            E.getDerivedStateFromProps == null &&
            ...
            d.componentWillReceiveProps(v, x),
          t.__v == n.__v ||
            (!d.__e &&
              d.shouldComponentUpdate != null &&
              !1 === d.shouldComponentUpdate(v, d.__s, x)))
        ) {
          (t.__v != n.__v && ((d.props = v), (d.state = d.__s), (d.__d = !1)),
            ...
            ne.push.apply(d.__h, d._sb),
            (d._sb = []),
            d.__h.length && o.push(d));
          break n;
        }
        (d.componentWillUpdate != null && d.componentWillUpdate(v, d.__s, x),
          y &&
            d.componentDidUpdate != null &&
            d.__h.push(function () {
              d.componentDidUpdate(p, m, g);
            }));
      }
      if (
        ((d.context = x),
        ...
        while (d.__d && ++C < 25);
      ((d.state = d.__s),
        d.getChildContext != null && (r = k(k({}, r), d.getChildContext())),
        y &&
          !f &&
          d.getSnapshotBeforeUpdate != null &&
          (g = d.getSnapshotBeforeUpdate(p, m)),
        (w =
          u != null && u.type === se && u.key == null
            ? Te(u.props.children)
            : u),
        (s = me(e, O(w) ? w : [w], t, n, r, i, a, o, s, c, l)),
        (d.base = t.__e),
        (t.__u &= -161),
        d.__h.length && o.push(d),
        _ && (d.__E = d.__ = null));
      ...
      if (((t.__v = null), c || a != null))
        if (e.then) {
          ...
          for (T = a.length; T--; ) ie(a[T]);
          Ce(t);
        }
      else ((t.__e = n.__e), (t.__k = n.__k), e.then || Ce(t));
      h.__e(e, t, n);
    }
  else
    a == null && t.__v == n.__v
      ? ((t.__k = n.__k), (t.__e = n.__e))
      : (s = t.__e = Ee(n.__e, t, n, r, i, a, o, c, l));
...
function Ee(e, t, n, r, i, a, o, s, c) {
  ...
  if (b == null) v === y || (s && e.data == y) || (e.data = y);
    ...
    if (((a &&= m.call(e.childNodes)), !s && a != null))
      for (v = {}, l = 0; l < e.attributes.length; l++)
        v[(p = e.attributes[l]).name] = p.value;
    for (l in v)
      ((p = v[l]),
...
function Oe(e, t, n) {
  ...
  if (
    ...
    (r = e.ref) && ((r.current && r.current != e.__e) || De(r, null, t)),
    (r = e.__c) != null)
  ) {
  ...
  if ((r = e.__k))
    for (i = 0; i < r.length; i++)
      r[i] && Oe(r[i], t, n || typeof e.type != `function`);
...
function Ae(e, t, n) {
  ...
  (t == document && (t = document.documentElement),
    ...
    Se(
      t,
      (e = ((!r && n) || t).__k = A(se, null, [e])),
      i || te,
      te,
      t.namespaceURI,
      !r && n ? [n] : i ? null : t.firstChild ? m.call(t.childNodes) : null,
      a,
...
function Me(e, t, n) {
  ...
  return (
    arguments.length > 2 &&
      (s.children = arguments.length > 3 ? m.call(arguments, 2) : n),
    ae(e.type, s, r || e.key, i || e.ref, null)
  );
}
function Ne(e) {
  function t(e) {
...
function P(e, t) {
  var n = Ge(Pe++, 3);
  !M.__s && at(n.__H, t) && ((n.__ = e), (n.u = t), j.__H.__h.push(n));
}
function qe(e, t) {
  var n = Ge(Pe++, 4);
  !M.__s && at(n.__H, t) && ((n.__ = e), (n.u = t), j.__h.push(n));
}
function F(e) {
  return (
    (Le = 5),
...
function Ze(e) {
  ...
  return (
    (n.c = e),
    t ? (n.__ ?? ((n.__ = !0), t.sub(j)), t.props.value) : e.__
  );
}
function Qe(e, t) {
...
function et() {
  for (var e; (e = Re.shift()); ) {
    ...
    if (e.__P && t)
      try {
        (t.__h.some(rt), t.__h.some(it), (t.__h = []));
      } catch (n) {
        ((t.__h = []), M.__e(n, e.__v));
      }
  }
  ...
  (M.__r = function (e) {
    ...
    (t &&
      (Fe === j
        ...
        : (t.__h.some(rt), t.__h.some(it), (t.__h = []), (Pe = 0))),
      (Fe = j));
  }),
  (M.diffed = function (e) {
    Ve && Ve(e);
    ...
    (t &&
      t.__H &&
      (t.__H.__h.length &&
        ((Re.push(t) !== 1 && Ie === M.requestAnimationFrame) ||
          ((Ie = M.requestAnimationFrame) || nt)(et)),
...
function gt(e, t) {
  function n(e) {
    ...
    return (
      ...
      t ? !t(this.props, e) || n != e.ref : ct(this.props, e)
    );
  }
  function r(t) {
    return ((this.shouldComponentUpdate = n), A(e, t));
  }
  return (
...
(((ht.prototype = new ce()).isPureReactComponent = !0),
  (ht.prototype.shouldComponentUpdate = function (e, t) {
    return ct(this.props, e) || ct(this.state, t);
  }));
var _t = h.__b;
h.__b = function (e) {
...
var bt = function (e, t) {
    return e == null ? null : _e(_e(e).map(t));
  },
  xt = {
    map: bt,
    forEach: bt,
    count: function (e) {
      return e ? _e(e).length : 0;
    },
    only: function (e) {
      var t = _e(e);
...
((h.unmount = function (e) {
  ...
  (Et.prototype.render = function (e, t) {
    ...
    var i = t.__a && A(se, null, e.fallback);
    return (i && (i.__u &= -33), [A(se, null, t.__a ? null : e.children), i]);
  }));
...
function Mt(e) {
  ...
  Ae(A(jt, { context: t.context }, e.__v), t.v);
}
function Nt(e, t) {
  var n = A(Mt, { __v: e, h: t });
  return ((n.containerInfo = t), n);
}
(((kt.prototype = new ce()).__a = function (e) {
  var t = this,
    n = Dt(t.__v),
    r = t.l.get(e);
  return (
...
((ce.prototype.isReactComponent = !0),
  [
    `componentWillMount`,
...
function $t(e) {
  return Xt(e) ? Me.apply(null, arguments) : e;
}
function en(e) {
...
var nn = {
  ...
  flushSync: function (e, t) {
    var n = h.debounceRendering;
    h.debounceRendering = function (e) {
      return e();
    };
    var r = e(t);
    return ((h.debounceRendering = n), r);
  },
...
var _n = gn(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  vn = gn(/Edge/i),
  yn = gn(/firefox/i),
  bn = gn(/safari/i) && !gn(/chrome/i) && !gn(/android/i),
  xn = gn(/iP(ad|od|hone)/i),
  Sn = gn(/chrome/i) && gn(/android/i),
  Cn = { capture: !1, passive: !1 };
function I(e, t, n) {
  e.addEventListener(t, n, !_n && Cn);
}
function L(e, t, n) {
  e.removeEventListener(t, n, !_n && Cn);
}
function wn(e, t) {
  if (t) {
...
function En(e, t, n, r) {
  if (e) {
    ...
    do {
      if (
        (t != null &&
          (t[0] === `>` ? e.parentNode === n && wn(e, t) : wn(e, t))) ||
        (r && e === n)
      )
        return e;
      if (e === n) break;
...
function z(e, t, n, r, i) {
  if (!(!e.getBoundingClientRect && e !== window)) {
    ...
    if (
      (e !== window && e.parentNode && e !== jn()
        ...
        : ((o = 0),
          ...
          (d = window.innerWidth)),
      (t || n) && e !== window && ((i ||= e.parentNode), !_n))
    )
      do
        if (
          i &&
          i.getBoundingClientRect &&
          (R(i, `transform`) !== `none` || (n && R(i, `position`) !== `static`))
        ) {
          var f = i.getBoundingClientRect();
          ((o -= f.top + parseInt(R(i, `border-top-width`))),
            (s -= f.left + parseInt(R(i, `border-left-width`))),
            (c = o + a.height),
            (l = s + a.width));
          break;
        }
    ...
    return { top: o, left: s, bottom: c, right: l, width: d, height: u };
  }
}
function Mn(e, t, n) {
  for (var r = Rn(e, !0), i = z(e)[t]; r; ) {
    var a = z(r)[n],
      o = void 0;
...
function Pn(e, t) {
  for (
    ...
    n && (n === X.ghost || R(n, `display`) === `none` || (t && !wn(n, t)));
  )
...
function Kn(e, t, n) {
  ...
  return (
    Array.from(e.children).forEach(function (i) {
      if (!(!En(i, t.draggable, e, !1) || i.animated || i === n)) {
        var a = z(i);
  ...
  return {
      ...
      ((e = []),
        this.options.animation &&
          [].slice.call(this.el.children).forEach(function (t) {
            if (!(R(t, `display`) === `none` || t === X.ghost)) {
              e.push({ target: t, rect: z(t) });
              var n = ln({}, e[e.length - 1].rect);
    ...
    animate: function (e, t, n, r) {
      if (r) {
        ...
        ((e.animatingX = !!s),
          (e.animatingY = !!c),
          R(e, `transform`, `translate3d(` + s + `px,` + c + `px,0)`),
          (this.forRepaintDummy = Jn(e)),
          R(
            e,
            `transition`,
            `transform ` +
          ...
          R(e, `transform`, `translate3d(0,0,0)`),
...
var Xn = [],
  Zn = { initializeByDefault: !0 },
  Qn = {
    mount: function (e) {
      for (var t in Zn) Zn.hasOwnProperty(t) && !(t in e) && (e[t] = Zn[t]);
    ...
    pluginEvent: function (e, t, n) {
      ...
      Xn.forEach(function (r) {
        t[r.pluginName] &&
          (t[r.pluginName][i] && t[r.pluginName][i](ln({ sortable: t }, n)),
          t.options[r.pluginName] &&
            t[r.pluginName][e] &&
            t[r.pluginName][e](ln({ sortable: t }, n)));
      });
    },
    initializePlugins: function (e, t, n, r) {
      for (var i in (Xn.forEach(function (r) {
        var i = r.pluginName;
      ...
      return (
        Xn.forEach(function (r) {
          typeof r.eventProperties == `function` &&
            sn(n, r.eventProperties.call(t[r.pluginName], e));
        }),
        n
      );
    },
...
function $n(e) {
  ...
  if (((t ||= n && n[B]), t)) {
    ...
    (window.CustomEvent && !_n && !vn
      ? (h = new CustomEvent(r, { bubbles: !0, cancelable: !0 }))
      : ((h = document.createEvent(`Event`)), h.initEvent(r, !0, !0)),
      (h.to = o || n),
      (h.from = s || n),
      (h.item = i || n),
      (h.clone = a),
      ...
      (h.newDraggableIndex = d),
      (h.originalEvent = f),
      (h.pullMode = p ? p.lastPutMode : void 0));
    var v = ln(ln({}, m), Qn.getEventProperties(r, t));
...
var U,
  ...
  Or = xn,
  kr = vn || _n ? `cssFloat` : `float`,
  Ar = Dr && !Sn && !xn && `draggable` in document.createElement(`div`),
  jr = (function () {
    if (Dr) {
      if (_n) return !1;
  ...
  Mr = function (e, t) {
    var n = R(e),
      ...
      o = i && R(i),
      s = a && R(a),
      c = o && parseInt(o.marginLeft) + parseInt(o.marginRight) + z(i).width,
      l = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + z(a).width;
    if (n.display === `flex`)
...
function X(e, t) {
  ...
  ((this.el = e), (this.options = t = sn({}, t)), (e[B] = this));
  var n = {
    group: null,
    sort: !0,
    disabled: !1,
    ...
    supportPointer:
      X.supportPointer !== !1 && `PointerEvent` in window && (!bn || xn),
    emptyInsertThreshold: 5,
  };
  for (var r in (Qn.initializePlugins(this, e, n), n))
    !(r in t) && (t[r] = n[r]);
  for (var i in (Fr(t), this))
    i.charAt(0) === `_` &&
      typeof this[i] == `function` &&
      (this[i] = this[i].bind(this));
  ((this.nativeDraggable = t.forceFallback ? !1 : Ar),
...
X.prototype = {
  ...
  _getDirection: function (e, t) {
    return typeof this.options.direction == `function`
      ? this.options.direction.call(this, e, t, U)
    ...
    if (e.cancelable) {
      ...
      if (
        ...
        !U &&
          ...
          ((s = En(s, r.draggable, n, !1)), !(s && s.animated) && nr !== s))
      ) {
        if (((ir = Fn(s)), (or = Fn(s, r.draggable)), typeof l == `function`)) {
  ...
  _prepareDragStart: function (e, t, n) {
    ...
    if (n && !U && n.parentNode === i) {
      ...
      if (
        ...
        (gr = fr.clientX - c.left),
        (_r = fr.clientY - c.top),
        (this._lastX = (t || e).clientX),
        (this._lastY = (t || e).clientY),
        (U.style[`will-change`] = `all`),
        (s = function () {
          if ((V(`delayEnded`, r, { evt: e }), X.eventCanceled)) {
            r._onDrop();
            return;
          }
          (r._disableDelayedDragEvents(),
            !yn && r.nativeDraggable && (U.draggable = !0),
            r._triggerDragStart(e, t),
            H({ sortable: r, name: `choose`, originalEvent: e }),
            On(U, a.chosenClass, !0));
        }),
        ...
        I(o, `touchmove`, Rr),
        a.supportPointer
          ? (I(o, `pointerup`, r._onDrop),
            !this.nativeDraggable && I(o, `pointercancel`, r._onDrop))
        ...
        V(`delayStart`, this, { evt: e }),
        a.delay &&
          (!a.delayOnTouchOnly || t) &&
          (!this.nativeDraggable || !(vn || _n)))
      ) {
        if (X.eventCanceled) {
          this._onDrop();
          return;
        ...
        (a.supportPointer
          ? (I(o, `pointerup`, r._disableDelayedDrag),
            I(o, `pointercancel`, r._disableDelayedDrag))
          : (I(o, `mouseup`, r._disableDelayedDrag),
            I(o, `touchend`, r._disableDelayedDrag),
            I(o, `touchcancel`, r._disableDelayedDrag)),
          I(o, `mousemove`, r._delayedDragTouchMoveHandler),
          I(o, `touchmove`, r._delayedDragTouchMoveHandler),
          a.supportPointer &&
            I(o, `pointermove`, r._delayedDragTouchMoveHandler),
  ...
  _triggerDragStart: function (e, t) {
    ((t ||= e.pointerType == `touch` && e),
      !this.nativeDraggable || t
        ...
        : (I(U, `dragend`, this), I(K, `dragstart`, this._onDragStart)));
    try {
      document.selection
        ? Xr(function () {
  ...
  _dragStarted: function (e, t) {
    if (((lr = !1), K && U)) {
      (V(`dragStarted`, this, { evt: t }),
        this.nativeDraggable && I(document, `dragover`, zr));
      var n = this.options;
      (!e && On(U, n.dragClass, !1),
        On(U, n.ghostClass, !0),
        (X.active = this),
        e && this._appendGhost(),
  ...
  _emulateDragOver: function () {
    if (pr) {
      ((this._lastX = pr.clientX), (this._lastY = pr.clientY), Ir());
      for (
        var e = document.elementFromPoint(pr.clientX, pr.clientY), t = e;
        e &&
        e.shadowRoot &&
        ((e = e.shadowRoot.elementFromPoint(pr.clientX, pr.clientY)), e !== t);
      )
        t = e;
      if ((U.parentNode[B]._isOutsideThisEl(e), t))
        do {
          if (t[B]) {
            var n = void 0;
            if (
  ...
  _onTouchMove: function (e) {
    if (fr) {
      var t = this.options,
        ...
        c = Or && Y && In(Y),
        l =
          (i.clientX - fr.clientX + r.x) / (o || 1) +
          (c ? c[0] - wr[0] : 0) / (o || 1),
        u =
          (i.clientY - fr.clientY + r.y) / (s || 1) +
          (c ? c[1] - wr[1] : 0) / (s || 1);
      if (!X.active && !lr) {
        if (
          n &&
  ...
  _appendGhost: function () {
    if (!G) {
      var e = this.options.fallbackOnBody ? document.body : K,
        t = z(U, !0, Or, !0, e),
        n = this.options;
      if (Or) {
        for (
          ...
          Y = Y.parentNode;
        (Y !== document.body && Y !== document.documentElement
          ? (Y === document && (Y = jn()),
            (t.top += Y.scrollTop),
            (t.left += Y.scrollLeft))
          : (Y = jn()),
      ...
      ((G = U.cloneNode(!0)),
        On(G, n.ghostClass, !1),
        On(G, n.fallbackClass, !0),
        On(G, n.dragClass, !0),
        R(G, `transition`, ``),
        R(G, `transform`, ``),
        R(G, `box-sizing`, `border-box`),
        R(G, `margin`, 0),
        R(G, `top`, t.top),
        R(G, `left`, t.left),
        R(G, `width`, t.width),
        R(G, `height`, t.height),
        R(G, `opacity`, `0.8`),
        R(G, `position`, Or ? `absolute` : `fixed`),
        R(G, `zIndex`, `100000`),
        R(G, `pointerEvents`, `none`),
        (X.ghost = G),
        e.appendChild(G),
        R(
          G,
          `transform-origin`,
          (gr / parseInt(G.style.width)) * 100 +
            `% ` +
            (_r / parseInt(G.style.height)) * 100 +
            `%`,
        ));
    }
  },
  _onDragStart: function (e, t) {
    var n = this,
      r = e.dataTransfer,
      i = n.options;
    if ((V(`dragStart`, this, { evt: e }), X.eventCanceled)) {
      this._onDrop();
      return;
    }
    (V(`setupClone`, this),
      X.eventCanceled ||
        ...
        (q.style[`will-change`] = ``),
        this._hideClone(),
        On(q, this.options.chosenClass, !1),
        (X.clone = q)),
      (n.cloneId = Xr(function () {
        (V(`clone`, n),
          !X.eventCanceled &&
            (n.options.removeCloneOnHide || K.insertBefore(q, U),
            n._hideClone(),
            H({ sortable: n, name: `clone` })));
      })),
      !t && On(U, i.dragClass, !0),
      t
        ? ((ur = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
        : (L(document, `mouseup`, n._onDrop),
          L(document, `touchend`, n._onDrop),
          L(document, `touchcancel`, n._onDrop),
          r &&
            ((r.effectAllowed = `move`), i.setData && i.setData.call(n, r, U)),
          I(document, `drop`, n),
          R(U, `transform`, `translateZ(0)`)),
      (lr = !0),
      (n._dragStartId = Xr(n._dragStarted.bind(n, t, e))),
      I(document, `selectstart`, n),
      (vr = !0),
      window.getSelection().removeAllRanges(),
      bn && R(document.body, `user-select`, `none`));
  },
  _onDragOver: function (e) {
    ...
    function _(r) {
      return (
        h(`dragOverCompleted`, { insertion: r }),
        r &&
          (l ? c._hideClone() : c._showClone(p),
          p !== d &&
            (On(U, J ? J.options.ghostClass : c.options.ghostClass, !1),
            On(U, o.ghostClass, !0)),
          J !== p && p !== X.active
            ? (J = p)
            : p === X.active && J && (J = null),
          d === p && (p._ignoreWhileAnimating = n),
        ...
        ((n === U && !U.animated) || (n === t && !n.animated)) && (yr = null),
        !o.dragoverBubble &&
          !e.rootEl &&
          n !== document &&
          (U.parentNode[B]._isOutsideThisEl(e.target), !r && Rr(e)),
        !o.dragoverBubble && e.stopPropagation && e.stopPropagation(),
        (m = !0)
      );
    }
    function v() {
    ...
    if (
      ...
      c &&
        ...
        (l
          ? u || (a = W !== K)
          : J === this ||
            ((this.lastPutMode = cr.checkPull(this, c, U, e)) &&
              s.checkPut(this, c, U, e))))
    ) {
      if (
        ((f = this._getDirection(e, n) === `vertical`),
        (r = z(U)),
        h(`dragOverValid`),
        X.eventCanceled)
      )
      ...
      if (a)
        return (
          ...
          this._hideClone(),
          h(`revert`),
          X.eventCanceled || (tr ? K.insertBefore(U, tr) : K.appendChild(U)),
          _(!0)
        );
      var y = Pn(t, o.draggable);
      if (!y || (Gr(e, f, this) && !y.animated)) {
        if (y === U) return _(!1);
        if (
          (y && t === e.target && (n = y),
          n && (i = z(n)),
          Vr(K, t, U, r, n, i, e, !!n) !== !1)
        )
          return (
            g(),
            y && y.nextSibling
              ? t.insertBefore(U, y.nextSibling)
              : t.appendChild(U),
            (W = t),
            v(),
            _(!0)
        ...
        var b = Nn(t, 0, o, !0);
        if (b === U) return _(!1);
        if (((n = b), (i = z(n)), Vr(K, t, U, r, n, i, e, !1) !== !1))
          return (g(), t.insertBefore(U, b), (W = t), v(), _(!0));
        ...
        var x = 0,
          ...
          C = U.parentNode !== t,
          w = !Nr(
            (U.animated && U.toRect) || r,
            (n.animated && n.toRect) || i,
            f,
          ),
          T = f ? `top` : `left`,
          E = Mn(n, `top`, `top`) || Mn(U, `top`, `top`),
          ee = E ? E.scrollTop : void 0;
        (yr !== n && ((S = i[T]), (xr = !1), (Sr = (!w && o.invertSwap) || C)),
          (x = Kr(
            e,
            n,
            i,
        ...
        if (x !== 0) {
          var te = Fn(U);
          do ((te -= x), (D = W.children[te]));
          while (D && (R(D, `display`) === `none` || D === G));
        }
        if (x === 0 || D === n) return _(!1);
        ((yr = n), (br = x));
        var ne = n.nextElementSibling,
          re = !1;
        re = x === 1;
        var O = Vr(K, t, U, r, n, i, e, re);
        if (O !== !1)
          return (
            (O === 1 || O === -1) && (re = O === 1),
            (Tr = !0),
            ...
            re && !ne
              ? t.appendChild(U)
              : n.parentNode.insertBefore(U, re ? ne : n),
            E && Wn(E, 0, ee - E.scrollTop),
            (W = U.parentNode),
            S !== void 0 && !Sr && (Cr = Math.abs(S - z(n)[T])),
            v(),
            _(!0)
          );
      }
  ...
  _offMoveEvents: function () {
    (L(document, `mousemove`, this._onTouchMove),
      ...
      L(document, `dragover`, Rr),
      L(document, `mousemove`, Rr),
      L(document, `touchmove`, Rr));
  },
  ...
  _onDrop: function (e) {
    ...
    ((lr = !1),
      ...
      clearTimeout(this._dragStartTimer),
      Zr(this.cloneId),
      Zr(this._dragStartId),
      this.nativeDraggable &&
        (L(document, `drop`, this), L(t, `dragstart`, this._onDragStart)),
      this._offMoveEvents(),
      this._offUpEvents(),
      bn && R(document.body, `user-select`, ``),
      R(U, `transform`, ``),
      e &&
        (vr &&
          (e.cancelable && e.preventDefault(),
        ...
        (K === W || (J && J.lastPutMode !== `clone`)) &&
          q &&
          q.parentNode &&
          q.parentNode.removeChild(q),
        U &&
          (this.nativeDraggable && L(U, `dragend`, this),
          Hr(U),
          (U.style[`will-change`] = ``),
          vr &&
            !lr &&
            On(U, J ? J.options.ghostClass : this.options.ghostClass, !1),
          On(U, this.options.chosenClass, !1),
          H({
            sortable: this,
            name: `unchoose`,
            toEl: W,
          ...
          K === W
            ? ar !== ir &&
              ar >= 0 &&
              (H({ sortable: this, name: `update`, toEl: W, originalEvent: e }),
              H({ sortable: this, name: `sort`, toEl: W, originalEvent: e }))
            : (ar >= 0 &&
                (H({
                  rootEl: W,
                  name: `add`,
              ...
              J && J.save()),
          X.active &&
            ((ar == null || ar === -1) && ((ar = ir), (sr = or)),
            H({ sortable: this, name: `end`, toEl: W, originalEvent: e }),
            this.save()))),
      this._nulling());
  },
  _nulling: function () {
  ...
  toArray: function () {
    for (
      ...
      ((t = n[r]),
        En(t, a.draggable, this.el, !1) &&
          e.push(t.getAttribute(a.dataIdAttr) || Jr(t)));
    return e;
  },
  sort: function (e, t) {
    var n = {},
    ...
    (this.toArray().forEach(function (e, t) {
      var i = r.children[t];
      En(i, this.options.draggable, r, !1) && (n[e] = i);
    }, this),
  ...
  closest: function (e, t) {
    return En(e, t || this.options.draggable, this.el, !1);
  },
  option: function (e, t) {
    var n = this.options;
    if (t === void 0) return n[e];
    var r = Qn.modifyOption(this, e, t);
  ...
  destroy: function () {
    ...
    ((e[B] = null),
      ...
      this._onDrop(),
      this._disableDelayedDragEvents(),
      dr.splice(dr.indexOf(this.el), 1),
      (this.el = e = null));
  },
  _hideClone: function () {
    if (!rr) {
  ...
  _showClone: function (e) {
    ...
    if (rr) {
      ...
      (U.parentNode == K && !this.options.group.revertClone
        ? K.insertBefore(q, U)
        : tr
          ? K.insertBefore(q, tr)
          : K.appendChild(q),
        this.options.group.revertClone && this.animate(U, q),
        R(q, `display`, ``),
        (rr = !1));
    }
  },
...
function Wr(e, t, n) {
  var r = z(Nn(n.el, 0, n.options, !0)),
    i = Kn(n.el, n.options, G),
    a = 10;
  return t
...
function Gr(e, t, n) {
  var r = z(Pn(n.el, n.options.draggable)),
    i = Kn(n.el, n.options, G),
    a = 10;
  return t
    ? e.clientX > i.right + a || (e.clientY > r.bottom && e.clientX > r.left)
...
(Dr &&
  I(document, `touchmove`, function (e) {
    (X.active || lr) && e.cancelable && e.preventDefault();
  }),
  (X.utils = {
    on: I,
    off: L,
  ...
  (X.mount = function () {
    ...
    (t[0].constructor === Array && (t = t[0]),
      t.forEach(function (e) {
        ...
        (e.utils && (X.utils = ln(ln({}, X.utils), e.utils)), Qn.mount(e));
      }));
  }),
...
function ai() {
  ...
  return (
    (e.prototype = {
      ...
      nulling: function () {
        ((ri = $r = Qr = ei = ii = ti = ni = null), (Z.length = 0));
      },
      ...
      _handleAutoScroll: function (e, t) {
        ...
        if (
          ((ri = e),
          t || this.options.forceAutoScrollFallback || vn || _n || bn)
        ) {
          ...
          ei &&
            ...
            (ii = setInterval(function () {
              var a = Rn(document.elementFromPoint(r, i), !0);
              (a !== o && ((o = a), oi()), ci(e, n.options, a, t));
            }, 10)),
            (ti = r),
            (ni = i));
        } else {
          if (!this.options.bubbleScroll || Rn(a, !0) === jn()) {
            oi();
            return;
          }
          ci(e, this.options, Rn(a, !1), !1);
        }
      },
    }),
    sn(e, { pluginName: `scroll`, initializeByDefault: !0 })
  );
}
function oi() {
          ...
          ? ((x =
            ...
            (S =
              ...
              (T.overflowY === `auto` ||
                ...
                T.overflowY === `visible`)))
          : ((x =
              y < C && (T.overflowX === `auto` || T.overflowX === `scroll`)),
            (S =
              b < w && (T.overflowY === `auto` || T.overflowY === `scroll`)));
        var D =
            x &&
            (Math.abs(v - i) <= o && E + y < C) - (Math.abs(_ - i) <= o && !!E),
          te =
            S &&
            (Math.abs(g - a) <= o && ee + b < w) -
              (Math.abs(h - a) <= o && !!ee);
        if (!Z[d]) for (var ne = 0; ne <= d; ne++) Z[ne] || (Z[ne] = {});
        ((Z[d].vx != D || Z[d].vy != te || Z[d].el !== p) &&
          ((Z[d].el = p),
          (Z[d].vx = D),
          (Z[d].vy = te),
          clearInterval(Z[d].pid),
          (D != 0 || te != 0) &&
            ((l = !0),
            (Z[d].pid = setInterval(
              function () {
                r && this.layer === 0 && X.active._onTouchMove(ri);
                var t = Z[this.layer].vy ? Z[this.layer].vy * s : 0,
                  n = Z[this.layer].vx ? Z[this.layer].vx * s : 0;
                (typeof u == `function` &&
                  u.call(
                    X.dragged.parentNode[B],
                    n,
                    t,
                    e,
                    ri,
                  ...
                  Wn(Z[this.layer].el, n, t);
              }.bind({ layer: d }),
              24,
            )))),
          d++);
      } while (t.bubbleScroll && f !== c && (f = Rn(f, !1)));
      ei = l;
    }
  }, 30),
  li = function (e) {
...
((ui.prototype = {
  ...
  onSpill: function (e) {
    ...
    var r = Nn(this.sortable.el, this.startIndex, this.options);
  ...
  sn(ui, { pluginName: `revertOnSpill` }));
function di() {}
((di.prototype = {
  onSpill: function (e) {
    var t = e.dragEl,
  ...
  sn(di, { pluginName: `removeOnSpill` }),
  X.mount(new ai()),
  X.mount(di, ui));
var Q = {
    UNSTARTED: -1,
  ...
  fi = `https://www.youtube-nocookie.com`,
  pi = class {
    iframeElement;
    videoId;
    onReadyCallback;
    ...
    onIframeLoad = () => {
      ...
      let e = this.iframeElement.contentWindow;
      e && e.postMessage(JSON.stringify({ event: `listening`, id: 1 }), fi);
    };
    sendCommand(e, t = []) {
      let n = this.iframeElement.contentWindow;
      n &&
        n.postMessage(
      ...
      switch (t.event) {
        case `onReady`:
          (console.debug(
            ...
            (() => {
              const _sec = this._postLoadSeekSec,
                _rate = this._postLoadSeekRate;
              if (_sec && _sec > 2) {
                this._postLoadSeekSec = null;
                window.setTimeout(() => {
                  this.seek(_sec).catch(() => {});
                  if (_rate && _rate !== 1) {
                    this.sendCommand(`setPlaybackRate`, [_rate]);
                    this._postLoadSeekRate = null;
                  }
                }, 800);
              } else if (_rate && _rate !== 1) {
                this._postLoadSeekRate = null;
                window.setTimeout(
                  () => this.sendCommand(`setPlaybackRate`, [_rate]),
                  800,
        ...
        case `onStateChange`: {
          let e = t.info;
          ((this.cachedPlayerState = e), this.handleStateChange(e));
          break;
        }
        case `infoDelivery`:
        case `initialDelivery`: {
          ...
          e &&
            ...
            (typeof e.currentTime == `number` &&
              (this.cachedCurrentTime = e.currentTime),
            typeof e.duration == `number` &&
              e.duration > 0 &&
              (this.cachedDuration = e.duration),
            typeof e.playerState == `number` &&
              (this.cachedPlayerState = e.playerState),
            typeof e.muted == `boolean` && (this.cachedMuted = e.muted),
            typeof e.playbackRate == `number` &&
              e.playbackRate > 0 &&
              (this.cachedPlaybackRate = e.playbackRate));
          break;
        }
        case `onError`: {
          let e = typeof t.info == `number` ? t.info : -1;
          if (
            (console.error(
              `[PlayerAdapter] Player error for video:`,
              this.videoId,
              `Error code:`,
              e,
            ),
            this.pendingLoadErrorHandler)
          ) {
            let t = this.pendingLoadErrorHandler;
            ((this.pendingLoadErrorHandler = null), t(e));
            return;
          }
    ...
    async loadVideo(e) {
      if (!(await this.waitForReady())) {
        console.warn(
          `[PlayerAdapter] Cannot load video - player not ready after waiting`,
        );
        return;
      }
      return (
        ...
        new Promise((t, n) => {
          var r = !1,
            ...
            a = function () {
              if (r) return;
              r = !0;
              _self.pendingLoadErrorHandler = null;
              i || _self.sendCommand(`unMute`);
              _self.ready = !0;
              var _sec = _self._postLoadSeekSec,
                _rate = _self._postLoadSeekRate;
              if (_sec && _sec > 2) {
                _self._postLoadSeekSec = null;
                _self._postLoadSeekRate = null;
                window.setTimeout(function () {
                  _self.seek(_sec).catch(function () {});
                  if (_rate && _rate !== 1)
                    _self.sendCommand(`setPlaybackRate`, [_rate]);
                }, 600);
              }
              t();
            },
          ...
          _self.pendingLoadErrorHandler = function (e) {
            window.clearInterval(s);
            window.clearTimeout(c);
            o(e);
          };
          i || _self.sendCommand(`mute`);
          _self.sendCommand(`loadVideoById`, [e]);
          var s = window.setInterval(function () {
              var t = _self.cachedPlayerState;
              t === Q.PLAYING
            ...
            c = window.setTimeout(function () {
              window.clearInterval(s);
              console.warn(
                `[PlayerAdapter] Video load timeout, marking as ready anyway`,
              );
              a();
            }, 5e3);
        })
    ...
    destroy() {
      ((this.destroyed = !0),
        ...
        (this.ready = !1),
        console.debug(
          `[PlayerAdapter] Destroyed player for video:`,
          this.videoId,
        ));
    }
    async seek(e) {
      ...
      for (
        ;
        t < 10 &&
        !(this.isReady() && (await this.getPlayerState()) !== Q.BUFFERING);
      )
        (t++, await new Promise((e) => window.setTimeout(e, 100)));
      if (!this.isReady()) {
        console.warn(`[PlayerAdapter] Player not ready for seek after waiting`);
        return;
      }
      try {
        (console.debug(`[PlayerAdapter] Seeking to:`, e),
    ...
    async seekAndPause(e) {
      if ((await this.seek(e), !this.isReady())) return;
      let t = this.cachedPlayerState;
      if (t === Q.PLAYING || t === Q.BUFFERING) {
        this.sendCommand(`pauseVideo`);
        return;
      }
      if (t === Q.PAUSED || t === Q.ENDED) {
        this.sendCommand(`pauseVideo`);
        return;
      }
      if (t === Q.UNSTARTED || t === Q.CUED) {
        await this.waitForAutoPause(e);
        return;
      }
      this.sendCommand(`pauseVideo`);
    }
    ...
    clearPendingAutoPause(e) {
      if (!this.pendingAutoPause) return;
      let t = this.pendingAutoPause;
      ((this.pendingAutoPause = null),
        window.clearTimeout(t.timeoutId),
        t.restoreMute && this.sendCommand(`unMute`),
        e && t.resolve());
    }
    async waitForAutoPause(e) {
      return new Promise((t) => {
        this.clearPendingAutoPause(!1);
        let n = !1;
        this.cachedMuted || (this.sendCommand(`mute`), (n = !0));
        let r = window.setTimeout(() => {
          this.pendingAutoPause?.timeoutId === r &&
            this.clearPendingAutoPause(!0);
        }, 2e3);
    ...
    handleStateChange(e) {
      if (!this.pendingAutoPause) return;
      let t = e === Q.PLAYING,
        n = e === Q.PAUSED || e === Q.ENDED;
      if (t) {
        let e = this.pendingAutoPause;
        (this.sendCommand(`pauseVideo`),
          this.sendCommand(`seekTo`, [e.timestamp, !0]),
          this.clearPendingAutoPause(!0));
      } else n && this.clearPendingAutoPause(!0);
    }
  },
  mi = class extends l.Modal {
    title;
    message;
    constructor(e, t, n) {
      (super(e), (this.title = t), (this.message = n));
    }
    onOpen() {
      let { contentEl: e } = this;
      (e.empty(),
        e.addClass(`youtnote-plugin__base-modal`),
        e
          .createDiv({ cls: `youtnote-plugin__base-modal-title` })
          .setText(this.title),
        e
          .createDiv({ cls: `youtnote-plugin__base-modal-message` })
          .setText(this.message));
      let t = e.createDiv({ cls: `youtnote-plugin__base-modal-buttons` });
  ...
  hi = class extends mi {
    buttonText;
    constructor(e, t, n, r = `OK`) {
      (super(e, t, n), (this.buttonText = r));
    }
    renderButtons(e) {
  ...
  gi = class extends mi {
    ...
    confirmText;
    cancelText;
    constructor(e, t, n, r, i = `Confirm`, a = `Cancel`) {
      (super(e, t, n),
        (this.onConfirm = r),
        (this.confirmText = i),
        (this.cancelText = a));
...
var vi = nn.memo(
  ({ app: e, video: t, isActive: n, onSelect: r, onDelete: i }) => {
    let a = F(null),
      o = F(null),
      s = F(null);
    P(() => {
      (a.current && (a.current.empty(), (0, l.setIcon)(a.current, `trash`)),
        o.current && (o.current.empty(), (0, l.setIcon)(o.current, `copy`)),
        s.current &&
          (s.current.empty(), (0, l.setIcon)(s.current, `grip-vertical`)));
    }, []);
    let c = () => {
        new gi(
          e,
      ...
      u = async () => {
        try {
          (await navigator.clipboard.writeText(t.url),
            new l.Notice(`Video URL was copied to the clipboard!`, 2e3));
        } catch (e) {
          (console.error(`Failed to copy URL:`, e),
            new l.Notice(`Failed to copy video URL!`, 2e3));
        }
      },
      d = (e) => {
        (e.stopPropagation(), c());
      ...
      f = async (e) => {
        (e.stopPropagation(), await u());
      };
    return $(`div`, {
      className: (0, an.default)(`youtnote-plugin__video-item`, {
        "youtnote-plugin__active": n,
      }),
      onClick: () => r(t.id),
      onContextMenu: (e) => {
        ...
        (n.addItem((e) => {
          ...
          n.addSeparator(),
          n.addItem((e) => {
            e.setTitle(`Delete video`)
              .setIcon(`trash`)
              .onClick(() => {
                c();
              });
            let t = e;
            (t.dom?.classList.add(`mod-warning`, `mod-danger`),
              t.iconEl?.classList.add(`mod-warning`, `mod-danger`));
          }),
          n.showAtMouseEvent(e.nativeEvent));
      },
      children: [
        $(`span`, { ref: s, className: `youtnote-plugin__drag-handle` }),
        t.thumbnail && $(`img`, { src: t.thumbnail, alt: t.title }),
        $(`span`, {
          className: `youtnote-plugin__video-title`,
...
vi.displayName = `VideoListItem`;
var yi = null;
function bi(e) {
  if (yi) return yi;
  if (!e.embedRegistry?.embedByExtension?.md)
    return (
      console.error(
        `[Youtnote] embedRegistry.embedByExtension.md is not available`,
      ),
      null
    );
  let t = createDiv();
  (t.hide(), activeDocument.body.appendChild(t));
  try {
    let n = e.embedRegistry.embedByExtension.md(
      { app: e, containerEl: t, state: {} },
      null,
      ``,
    );
    if (
      (n.load(),
      `editable` in n && (n.editable = !0),
      typeof n.showEditor == `function` && n.showEditor(),
      n.editMode)
    ) {
      let e = n.editMode,
        t = Object.getPrototypeOf(e),
        r =
          (t == null ? null : Object.getPrototypeOf(t))?.constructor ??
          e.constructor;
      r != null && (yi = r);
    }
    n.unload();
...
var Ei = ({
  ...
  return (
    P(() => {
      ((p.current = i), (m.current = r), (h.current = o));
    }, [i, r, o]),
    P(() => {
      if (!s.current) return;
      let r = s.current,
        i = t.plugin;
      i.MarkdownEditor ||= bi(e);
      let a = i.MarkdownEditor;
      if (!a) {
      ...
      class o extends a {
        updateBottomPadding() {}
        onUpdate(e, t) {
          if ((super.onUpdate(e, t), t)) {
            let e = this.get();
            m.current(e);
          }
        }
        buildLocalExtensions() {
          let n = super.buildLocalExtensions();
          if (
            ((!Si || !Ci || !wi) &&
              ((Si = u.Prec), (Ci = d.EditorView), (wi = d.keymap)),
            n.push(
              Si.highest(
                Ci.domEventHandlers({
                  focus: () => (
                    ...
                    window.setTimeout(() => {
                      let t = e.workspace;
                      ((t.activeEditor = g),
                        l.Platform.isMobile && e.mobileToolbar?.update());
                    }),
                    !0
                  ),
                  blur: () => (
            ...
            let e = (e, t) => () =>
              (h.current === `enter` ? t || e : !(t || e))
                ? ((f.current = !0), p.current(), !0)
                : !1;
            n.push(
              Si.highest(
                wi.of([
                  { key: `Enter`, run: e(!1, !1), shift: e(!1, !0) },
                  { key: `Mod-Enter`, run: e(!0, !1), shift: e(!0, !0) },
                ]),
              ),
            );
          }
      ...
      return (
        l.Platform.isMobile &&
          activeWindow.addEventListener(`keyboardDidShow`, v),
        () => {
          if (l.Platform.isMobile) {
            (activeWindow.removeEventListener(`keyboardDidShow`, v),
              t.activeEditor === g && (t.activeEditor = null));
            let n = e.workspace;
            n.activeEditor === g &&
              ((n.activeEditor = null), e.mobileToolbar?.update());
          }
          (i.removeChild(_), (c.current = null));
        }
      );
    }, [e, t]),
    $(`div`, {
      ...
      onBlur: (e) => {
        (!f.current && a && !e.currentTarget.contains(e.relatedTarget) && a(),
          (f.current = !1));
      },
      tabIndex: -1,
    })
...
function Mi(e) {
  ...
  if (!Oi.has(r)) return null;
  let i = null;
  return (
    r.includes(`youtu.be`)
      ? (i = n.pathname.split(`/`).filter(Boolean)[0] || null)
      : n.pathname === `/watch`
        ? (i = n.searchParams.get(`v`))
        : (n.pathname.startsWith(`/shorts/`) ||
            n.pathname.startsWith(`/live/`) ||
            n.pathname.startsWith(`/embed/`)) &&
          (i = n.pathname.split(`/`)[2] || null),
    i && Ai(i) ? i : null
  );
}
function Ni(e) {
...
function Pi(e) {
  let t = e.split(`
`);
  if (t[0]?.trim() !== `---`) return !1;
  for (let e = 1; e < t.length; e++) {
    let n = t[e].trim();
    if (n === `---`) return !1;
    if (/^youtnote\s*:\s*true\s*$/i.test(n)) return !0;
  }
  return !1;
}
function Fi(e) {
...
function Ii(e, t) {
  let n = e.trim();
  if (!n) return { seconds: 0, error: `Empty input` };
  if (!/^[\d.:]+$/.test(n))
    return {
      seconds: 0,
      error: `Invalid format: only numbers and colons allowed`,
    };
  if (!n.includes(`:`)) {
    let e = parseFloat(n);
    return isNaN(e)
      ? { seconds: 0, error: `Invalid number format` }
      : e < 0
        ? { seconds: 0, error: `Time cannot be negative` }
        : t > 0 && e > t
          ? { seconds: t, error: `Time exceeds video duration (max: ${Di(t)})` }
          : { seconds: Math.floor(e) };
  }
  let r = n.split(`:`);
  if (r.some((e) => e.trim() === ``))
...
function Li(e) {
  return e.reduce((e, t) => {
    let n = t.trim();
    return n ? e + n.split(/\s+/).filter((e) => e.length > 0).length : e;
  }, 0);
}
function Ri(e) {
...
var zi = nn.memo(
  ({ app: e, body: t, sourcePath: n, onDoubleClick: r, isExpanded: i }) => {
    let a = F(null),
      o = F(null);
    return (
      P(() => {
        if (a.current)
          return (
            (o.current ||= new l.Component()),
            a.current.empty(),
            l.MarkdownRenderer.render(e, t, a.current, n, o.current),
            () => {
              (o.current?.unload(), (o.current = null));
            }
          );
      }, [e, t, n]),
      $(`div`, {
        ...
        onClick: (t) => {
          ...
          if (r.tagName === `A`) {
            ...
            i &&
              (r.classList.contains(`internal-link`)
                ? e.workspace.openLinkText(i, n, t.ctrlKey || t.metaKey)
                : Fi(i) &&
                  activeWindow.open(i, `_blank`, `noopener,noreferrer`));
          }
        },
      })
    );
...
zi.displayName = `MarkdownNoteBody`;
var Bi = nn.memo(
  ({
    app: e,
    view: t,
    ...
    isActive: i,
    isEditing: a,
    editingTimestampId: o,
    editTimestampValue: s,
    timestampError: c,
    editNoteBody: u,
    maxDuration: d,
    newLineTrigger: f,
    ...
    onSaveEdit: g,
    onBodyChange: _,
    onStartTimestampEdit: v,
    onSaveTimestampEdit: y,
    onCancelTimestampEdit: b,
    onTimestampChange: x,
    onDelete: S,
  }) => {
    let C = o === n.id,
      w = (e) => {
        e.stopPropagation();
        let t = Di(n.timestampSec, d);
        v(n.id, t);
      },
      T = () => {
        h(n.id, n.bodyMarkdown);
      },
      E = () => {
        new gi(
          e,
      ...
      D = (e) => {
        (e.stopPropagation(), h(n.id, n.bodyMarkdown));
      },
      te = (e) => {
        (e.preventDefault(), e.stopPropagation(), g());
      },
      ne = (e) => {
        if (C || (l.Platform.isMobile && a)) return;
        (e.preventDefault(), e.stopPropagation(), m(n.id, n.timestampSec));
        let t = new l.Menu();
        (t.addItem((e) => {
          e.setTitle(`Edit note`)
            .setIcon(`pencil`)
            .onClick(() => {
              h(n.id, n.bodyMarkdown);
            });
          ...
          t.addItem((e) => {
            e.setTitle(`Edit timestamp`)
              .setIcon(`clock`)
              .onClick(() => {
                let e = Di(n.timestampSec, d);
                v(n.id, e);
              });
          }),
          t.addSeparator(),
          t.addItem((e) => {
            e.setTitle(`Delete note`)
              .setIcon(`trash`)
              .onClick(() => {
                E();
              });
          ...
          t.showAtMouseEvent(e.nativeEvent));
      },
      re = F(null),
      O = F(null),
      k = F(null),
    ...
    return (
      P(() => {
        re.current &&
          (re.current.empty(),
          (0, l.setIcon)(re.current, r ? `chevron-down` : `chevron-right`));
      }, [r]),
      P(() => {
        O.current && (O.current.empty(), (0, l.setIcon)(O.current, `pencil`));
      }, [r, a]),
      P(() => {
        k.current && (k.current.empty(), (0, l.setIcon)(k.current, `trash`));
      }, [r, a]),
      P(() => {
        ie.current && (ie.current.empty(), (0, l.setIcon)(ie.current, `check`));
      }, [a]),
      P(() => {
        if (C && A.current && !ae.current) {
          ((A.current.textContent = s), A.current.focus());
          let e = activeDocument.createRange();
          e.selectNodeContents(A.current);
          let t = activeWindow.getSelection();
          (t?.removeAllRanges(), t?.addRange(e), (ae.current = !0));
        } else C || (ae.current = !1);
      }, [C, s]),
      $(`div`, {
        className: (0, an.default)(`youtnote-plugin__note-card`, {
          expanded: r,
          "youtnote-plugin__active-note": i,
        }),
        onClick: (e) => {
          if (e.target.tagName === `A` || e.target.closest(`a`)) return;
          p(e, n.id, n.timestampSec);
        },
        onContextMenu: ne,
        children: [
          $(`div`, {
            className: `youtnote-plugin__note-header`,
            children: [
              $(`span`, {
                className: `youtnote-plugin__note-header-icon`,
                ref: re,
              }),
              C
                ? $(`div`, {
                    className: `youtnote-plugin__timestamp-editor`,
                    onClick: (e) => e.stopPropagation(),
                    children: [
                      $(`span`, {
                        ref: A,
                        className: (0, an.default)(
                          `youtnote-plugin__timestamp`,
                          `youtnote-plugin__timestamp-editing`,
                          { "youtnote-plugin__has-error": c },
                        ),
                        contentEditable: !0,
                        suppressContentEditableWarning: !0,
                        onInput: (e) => x(e.currentTarget.textContent || ``),
                        onBlur: () => {
                          if (oe.current) {
                            oe.current = !1;
                            return;
                      ...
                      c &&
                        $(`span`, {
                          className: `youtnote-plugin__timestamp-error`,
                          "aria-label": c,
                          children: `⚠`,
                        }),
                    ],
                ...
                : n.h6Label
                  ? $(`span`, {
                      className: `youtnote-plugin__timestamp youtnote-plugin__h6-label`,
                      "aria-label": n.h6Label,
                      children: n.h6Label,
                    })
                  : $(`span`, {
                      ...
                      children: Di(n.timestampSec, d),
                    }),
            ],
          }),
          a
            ? $(`div`, {
                className: `youtnote-plugin__note-editor-container`,
                onClick: (e) => e.stopPropagation(),
                children: [
                  $(Ei, {
                    app: e,
          ...
          r &&
            $(`div`, {
              className: `youtnote-plugin__note-actions`,
              children: [
                $(`button`, {
                  ref: O,
                  onClick: D,
...
var Vi = ({
  ...
  onUpdateVideos: s,
  onUpdateNotes: c,
  onExportSingleVideo: u,
  onExportAllVideos: d,
}) => {
  let f = Ye(() => i.filter((e) => e.videoId === a), [i, a]),
    p = Ye(() => r.find((e) => e.id === a), [r, a]),
    m = p?.url ?? null,
    h = Ye(() => {
      let e = f.map((e) => e.bodyMarkdown);
      return { words: Li(e), characters: Ri(e) };
    }, [f]),
    g = F(null),
    _ = F(null),
    v = F(null),
    ...
    [pe, me] = N(``),
    [he, ge] = N(null),
    _e = `youtnote-plugin__notes-left-pane-width`,
    ve = F(null),
    [ye, be] = N(50),
    xe = F(ye),
    [Se, Ce] = N(!1),
    we = l.Platform.isMobile && n.pinOnPhone;
  (P(() => {
    n.persistExpandedState || O(new Set());
  }, [a, n.persistExpandedState]),
    P(() => {
      n.singleExpandMode &&
        re.size > 1 &&
        O((e) => {
          let t = new Set();
          if (k && e.has(k)) t.add(k);
          else {
  ...
  (P(() => {
    ...
    P(() => {
      ...
      return (
        (() => {
          try {
            let n = e.loadLocalStorage(_e);
            if (!t) return;
            if (n) {
              let e = Number.parseFloat(n);
              Number.isNaN(e) || (be(e), (xe.current = e));
            }
          } catch (e) {
            console.error(`Failed to load pane width from local storage:`, e);
          }
        })(),
        () => {
          t = !1;
    ...
    P(() => {
      (b.current && (0, l.setIcon)(b.current, `file-down`),
        x.current && (0, l.setIcon)(x.current, `file-down`),
        S.current && (0, l.setIcon)(S.current, `list-plus`));
    }, [a, f.length, r.length, i.length]),
    P(() => {
      if (y.current) {
        let e = X.create(y.current, {
    ...
    P(() => {
      ...
      let u = _.current,
        d = async (e, t) => {
          try {
            let n = await e.getDuration(),
              r = Te.current.find((e) => e.id === t);
            r &&
              n > 0 &&
              n !== r.durationSec &&
              s(
                Te.current.map((e) =>
                  e.id === t ? { ...e, durationSec: n } : e,
                ),
              );
          } catch (e) {
      ...
      if (u && u.isReady())
        (console.debug(`[YoutnoteView] Loading new video in existing player`),
          ...
          u
            ...
            .catch((e) => {
              ...
              (console.warn(
                `[YoutnoteView] Failed to load video in existing player`,
                e,
              ),
                r(),
                w(!0));
        ...
        (u &&
          (console.debug(
            `[YoutnoteView] Existing adapter not ready, destroying before re-creating`,
          ),
          u.destroy(),
          (_.current = null)),
    ...
    P(
      () => () => {
        (_.current &&
          (_.current.destroy(), (_.current = null), (v.current = null)),
          (T.current &&= (window.clearTimeout(T.current), null)));
      },
      [],
    ));
  let Ee = async (e) => {
      let t = _.current;
      t &&
        (n.autoplayOnNoteSelect
          ? (await t.seek(e), await t.play())
          : await t.seekAndPause(e));
    },
    De = async (e, t, r) => {
      e.target.closest(`.youtnote-plugin__note-actions`) ||
        e.target.closest(`.youtnote-plugin__timestamp-editor`) ||
        (O((e) => {
          let r = new Set(e);
          return (
            r.has(t)
              ? r.delete(t)
              : (n.singleExpandMode && r.clear(), r.add(t)),
            r
          );
        }),
        ie(t),
    ...
    ke = async () => {
      ...
      (c([...i, s].sort((e, t) => e.timestampSec - t.timestampSec)),
        (t._pendingNewNoteId = o),
        ae(o),
        ie(null),
        O((e) => {
          let t = new Set(e);
          return (n.singleExpandMode && t.clear(), t.add(o), t);
        }),
        ce(o),
        ue(``));
    };
  ...
  let Ae = async (t) => {
      ...
      if (!n) {
        new hi(
          e,
          `Invalid URL`,
          `The URL you provided is not a valid YouTube URL.`,
        ).open();
        return;
      }
      let i = Ni(ee);
      ...
      let a = r.find((e) => Mi(e.url) === n);
      if (a) {
        (new hi(
          e,
          `Video duplication`,
          `This video already exists in your list.`,
        ).open(),
          window.setTimeout(() => {
            if ((o(a.id), y.current)) {
              let e = y.current.querySelectorAll(
                  `.youtnote-plugin__video-item`,
                ),
                t = r.findIndex((e) => e.id === a.id);
              t !== -1 &&
                e[t] &&
                e[t].scrollIntoView({ behavior: `smooth`, block: `nearest` });
            }
          }, 100),
          D(``));
        return;
      ...
      ne(!0);
      try {
        let e = await (0, l.requestUrl)({
          url: `https://www.youtube.com/oembed?url=${encodeURIComponent(i)}&format=json`,
        });
        if (e.status !== 200) throw Error(`Video not found or unavailable`);
        let t = e.json,
          n = Mi(i);
        ...
        for (const _q of _thumbQualities) {
          ...
          try {
            ...
            if (_r.status === 200 && (_len === 0 || _len > 2000)) {
              _thumb = _url;
              break;
            }
          } catch (_e) {
        ...
        if (!_thumb) {
          ...
          const _isLowRes =
            _oembed.includes(`default.jpg`) &&
            !_oembed.includes(`hq`) &&
            !_oembed.includes(`mq`) &&
            !_oembed.includes(`sd`) &&
            !_oembed.includes(`maxres`);
          _thumb =
            !_oembed || _isLowRes
              ? `https://img.youtube.com/vi/${n ?? ``}/hqdefault.jpg`
              : _oembed;
        }
        let a = {
          id: `video-${n ?? crypto.randomUUID()}`,
          url: i,
          title: t.title || `YouTube Video (${n ?? ``})`,
          thumbnail: _thumb,
          durationSec: 0,
        };
        (s([...r, a]),
        ...
        (console.error(`Error fetching YouTube metadata:`, t),
          new hi(
            e,
            `Unable to add video`,
            `The video may not exist, be private, be unavailable or be with invalid ID.`,
          ).open());
      } finally {
        ne(!1);
      }
      ...
      oe &&
        ...
        c(
          i
            ...
            .sort((e, t) => e.timestampSec - t.timestampSec),
        ),
        ie(oe),
        ce(null));
    },
    Me = (e) => {
      if ((me(e), e.trim())) {
        let t = Ii(e, p?.durationSec || 0);
        t.error ? ge(t.error) : ge(null);
      } else ge(null);
    },
    Ne = async (e) => {
      if (!pe.trim()) {
      ...
      (c(
        ...
        O((t) => {
          let r = new Set(t);
          return (n.singleExpandMode && r.clear(), r.add(e), r);
        }),
        ie(e));
      let r = _.current;
      r &&
        (n.autoplayOnNoteSelect
          ? (await r.seek(t.seconds), await r.play())
          : await r.seekAndPause(t.seconds));
    },
    Pe = () => {
      (fe(null), ge(null));
    },
    ...
    Fe = (e) => {
      ...
      (s(t), a === e && o(t.length > 0 ? t[0].id : null));
    },
    Ie = () => {
      if (!a) return;
      let t = new Map();
      f.forEach((e) => {
        let n = t.get(e.timestampSec) || [];
        (n.push(e), t.set(e.timestampSec, n));
      });
      let r = [];
      if (
        (t.forEach((e) => {
      ...
      let o = r.map((e) => Di(e.primary.timestampSec, p?.durationSec || 0)),
        s = o.length ? `: ${o.map((e) => `(${e})`).join(`, `)}` : ``;
      new gi(
        e,
        `Merge duplicates?`,
        `Found ${r.length} group(s) of notes with duplicate timestamps${s}. Do you really want to merge them?`,
        () => {
          let e = new Date().toISOString(),
            t = new Set(),
            a = new Map(),
            o = r.map((e) => e.primary.id);
          if (
            (r.forEach(({ primary: e, duplicates: n }) => {
              let r = [e, ...n].map((e) => e.bodyMarkdown).join(`

`);
              (a.set(e.id, r), n.forEach((e) => t.add(e.id)));
            }),
            c(
              i
                .map((t) =>
                  a.has(t.id)
                    ? {
                        ...t,
                        bodyMarkdown: a.get(t.id) || t.bodyMarkdown,
                        updatedAt: e,
                      }
                    : t,
                )
            ...
            (ie(e),
              O((t) => {
                if (n.singleExpandMode) {
                  let t = new Set();
                  return (t.add(e), t);
                }
                let r = new Set(t);
                return (o.forEach((e) => r.add(e)), r);
              }));
          }
          new l.Notice(`Merged ${o.length} group(s) of duplicates`, 2e3);
        },
        `Merge`,
        `Cancel`,
      ).open();
  ...
  P(() => {
    let t = (e) => {
        if (!Se || !ve.current) return;
        let t = ve.current.getBoundingClientRect(),
          n = t.width,
          r = ((e.clientX - t.left) / n) * 100;
        ((r = Math.max(25, Math.min(75, r))), be(r));
      },
      n = () => {
        Se && (Ce(!1), e.saveLocalStorage(_e, xe.current.toString()));
      };
    return (
      Se &&
        (activeDocument.addEventListener(`mousemove`, t),
        activeDocument.addEventListener(`mouseup`, n)),
      () => {
        (activeDocument.removeEventListener(`mousemove`, t),
          activeDocument.removeEventListener(`mouseup`, n));
      }
    );
  }, [e, Se, _e]);
  let Re = $(`div`, {
    className: `youtnote-plugin__player-container`,
    children: [
      $(`iframe`, {
        ref: g,
        className: (0, an.default)(`youtnote-plugin__iframe`, {
          "youtnote-plugin__iframe-hidden": !p,
        }),
        allow: `autoplay`,
      }),
      !p &&
        $(`div`, {
          className: `youtnote-plugin__empty-state`,
          children:
            r.length === 0 ? `Add a video to get started` : `Select a video`,
        }),
      p &&
        !C &&
        $(`div`, {
          className: `youtnote-plugin__loading-container`,
          children: [
            $(`div`, { className: `youtnote-plugin__dot-pulse` }),
            $(`div`, {
              className: `youtnote-plugin__loading-text`,
  ...
  return $(`div`, {
    ref: ve,
    className: (0, an.default)(`youtnote-plugin__plugin-container`, {
      "youtnote-plugin__iframe-sticky": we,
      "youtnote-plugin__is-resizing": Se,
      "youtnote-plugin__disabled": !C,
    }),
    children: [
      $(`div`, {
        ...
        children: [
          Re,
          $(`div`, {
            className: `youtnote-plugin__video-list-header`,
            children: [
              $(`div`, {
                className: `youtnote-plugin__video-list-header-content`,
                children: [`Videos: `, $(`span`, { children: r.length })],
              }),
              r.length > 0 &&
                i.length > 0 &&
                n.showExportAllButton !== false &&
                $(`button`, {
                  ref: x,
          ...
          $(`div`, {
            className: `youtnote-plugin__video-list`,
            ref: y,
            children: r.map((t) =>
              $(
                vi,
          ...
          $(`form`, {
            className: `youtnote-plugin__add-video-form`,
            onSubmit: (e) => {
              Ae(e);
            },
            children: [
              ...
              $(`button`, {
                ref: (e) => {
                  e &&
                    (e.empty(), (0, l.setIcon)(e, te ? `hourglass` : `plus`));
                },
                type: `submit`,
      ...
      $(`div`, {
        ...
        onMouseDown: Le,
        children: $(`div`, {
          className: `youtnote-plugin__resize-handle-line`,
        }),
      }),
      $(`div`, {
...
function Hi(e) {
  let t = new Map();
  for (let n of e) {
    let e = t.get(n.videoId);
    e ? e.push(n) : t.set(n.videoId, [n]);
  }
  return (
    t.forEach((e) => {
      e.sort((e, t) => e.timestampSec - t.timestampSec);
    }),
    t
  );
}
...
function Ui(e) {
  ...
  const finalizeNote = () => {
    if (
      curNote &&
      curNote.videoId &&
      curNote.timestampSec !== undefined &&
      curNote.bodyMarkdown !== undefined
    ) {
  ...
  for (let _fi = 0; _fi < urlList.length; _fi++) {
    ...
    if (vid)
      fmVideos.push({
        id: `video-${vid}`,
        url: u,
        title: linkLabels[_fi] || ``,
        durationSec: 0,
        thumbnail: `https://img.youtube.com/vi/${vid}/hqdefault.jpg`,
        _label: linkLabels[_fi] || null,
      });
  }
  ...
  const _hasAnyTimestampHeading =
    /^######\s*\[[\d:]+\]/m.test(e) || /^######\s+(?!\[[\d:]+\]).+/m.test(e);
  ...
  for (let i = 0; i < r.length; i++) {
    ...
    const headingM =
      _isTimestampLine || _isH6LabelLine
        ? null
        : line.match(/^(#{1,6})\s+(.+)$/);
    ...
    if (_isH6LabelLine && curVideo) {
      ...
      const noteId = `note-${curVideo.id}-h6-${h6Label
        .toLowerCase()
        .replace(/\s+/g, "-")
        .replace(/[^a-z0-9-]/g, "")}`;
      const pending = pendingLines.join(`\n`).trim();
...
function Wi(videos, notes, _originalContent) {
  ...
  if (_originalContent && typeof _originalContent === "string") {
    ...
    if (fmMatch) {
      ...
      if (videos.length > 0 && /^link[_ ]source\s*:/m.test(fmBlock)) {
        ...
        const _needsUpdate = videos.some(
          (v) => v.title && v.title !== (v._label || ""),
        );
        if (_needsUpdate) {
          const _toWikiLink = (v) =>
            v.title
      ...
      if (videos.length > 0 && /\{\{[^}]+\}\}/.test(fmBlock)) {
        ...
        fmBlock = fmBlock
          .split("\n")
          .map((line) =>
            /\{\{[^}]+\}\}/.test(line) ? resolveTemplate(line, _fmVars) : line,
          )
          .join("\n");
      }
  ...
  for (const video of videos) {
    ...
    for (const note of videoNotes) {
      ...
      lines.push(
        note.h6Label ? `###### ${note.h6Label}` : `###### [${timestamp}]`,
      );
...
function _serializeStructured(fmBlock, afterFm, videos, notes, notesByVideoId) {
  ...
  if (hasTimestampHeadings && !_multiVideo) {
    ...
    const firstTsIdx = (afterFm || "").search(
      /^######\s*(?:\[[\d:]+\]|(?!\[[\d:]+\]).+)/m,
    );
...
function Ki(videos, notes, _exportOpts) {
  return Gi(videos, notes, _exportOpts);
}
function qi(video, notes, _exportOpts) {
  return Gi([video], notes, _exportOpts);
}
var Ji = `youtnote-view`,
  Yi = class extends l.TextFileView {
    root = null;
    plugin;
    activeEditor = null;
    videos = [];
    ...
    getDisplayText() {
      return this.file ? this.file.basename : `Youtnote`;
    }
    getIcon() {
      return `youtnote`;
    }
    ...
    async onLoadFile(e) {
      if (!(await this.plugin.isYoutnoteFile(e))) {
        window.setTimeout(() => {
    ...
    setViewData(e, _cl) {
      ...
      this.render();
      if (typeof this._onViewDataChanged === "function")
        this._onViewDataChanged();
    }
    clear() {
      ((this.videos = []),
        (this.notes = []),
    ...
    onOpen() {
      ...
      this._btnExport = this.addAction(
        `file-down`,
        `Export as Markdown`,
        () => {
          (async () => {
            if (!this.file) return;
            let e = Ki(this.videos, this.notes, {
                headerTemplate:
                  this.plugin.settings.youtnoteExportHeaderTemplate,
                noteTemplate: this.plugin.settings.youtnoteExportNoteTemplate,
              }),
              t = `${this.file.basename} - Export`;
            await this.createExportFile(t, e);
          })();
        },
      );
      this._btnMarkdown = this.addAction(
        `file-text`,
        `Open as Markdown`,
        () => {
          ((this.plugin.youtnoteFileModes[
    ...
    onClose() {
      return (this.root?.unmount(), Promise.resolve());
    }
    ...
    handleUpdateNotes = (e) => {
      ((this.notes = e),
        this.render(),
        !this._pendingNewNoteId && this.requestSave());
    };
    ...
    handleExportSingleVideo = async (e) => {
      let t = this.videos.find((t) => t.id === e);
      if (!t) return;
      let n = qi(t, this.notes, {
          headerTemplate: this.plugin.settings.youtnoteExportHeaderTemplate,
          noteTemplate: this.plugin.settings.youtnoteExportNoteTemplate,
        }),
        r = Mi(t.url),
        i = r ? `Youtnote-${r}-Export` : `Youtnote-${e}-Export`;
      await this.createExportFile(i, n);
    };
    ...
    async createExportFile(e, t) {
      if (!this.file) return;
      let n = this.file.parent,
        r = `${e}.md`,
        i = n ? `${n.path}/${r}` : r,
        a = 1;
      for (; await this.plugin.app.vault.adapter.exists(i); )
        ((r = `${e} ${a}.md`), (i = n ? `${n.path}/${r}` : r), a++);
      let o = await this.plugin.app.vault.create(i, t);
      this.plugin.settings.openExportedFile
        ? await this.plugin.app.workspace.getLeaf(`tab`).openFile(o)
        : new l.Notice(`Exported file created: ${r}`, 2e3);
    }
    render() {
      this.root &&
        this.root.render(
  ...
  Qi = class extends l.Plugin {
    ...
    async onload() {
      (await this.loadDataState(),
        ...
        this.registerView(Ji, (e) => new Yi(e, this)),
        this.addCommand({
          id: `create-file`,
          ...
          callback: async () => {
            let e = this.app.workspace.getActiveFile()?.parent?.path || ``,
              ...
              r = e ? `${e}/${n}` : n,
              i = 1;
            for (; await this.app.vault.adapter.exists(r); )
              ((n = `${t} ${i}.md`), (r = e ? `${e}/${n}` : n), i++);
            let a = await this.app.vault.create(
                r,
                `---
youtnote: true
---
...
`,
              ...
              o = this.app.workspace.getLeaf(!0);
            (await o.openFile(a),
              (this.youtnoteFileModes[o.id ?? a.path] = Ji),
              await this.setYoutnoteView(o));
          },
        }),
        this.addCommand({
          id: `open-as-view`,
          name: `Open as view`,
          callback: () => {
            let e = this.app.workspace.getLeaf(!1);
            e &&
              e.view.getViewType() === `markdown` &&
              ((this.youtnoteFileModes[e.id ?? e.view.file?.path ?? ``] = Ji),
              this.setYoutnoteView(e));
          },
        }),
          ...
          this.app.workspace.on(`file-menu`, (e, t) => {
            (async () => {
              t instanceof l.TFile &&
                t.extension === `md` &&
                (await this.isYoutnoteFile(t)) &&
                e.addItem((e) => {
                  e.setTitle(`Open as youtnote view`)
                    .setIcon(`youtnote`)
                    .setSection(`pane`)
                    .onClick(() => {
                      let e = this.app.workspace.getLeavesOfType(`markdown`);
                      for (let n of e)
                        if (n.view.file?.path === t.path) {
                          ((this.youtnoteFileModes[n.id ?? t.path] = Ji),
                            this.setYoutnoteView(n));
                          return;
                        }
                      this.app.workspace
                        .getLeaf(!0)
      ...
      let e = !1,
        ...
        n = () => {
          this.app.workspace.iterateAllLeaves((e) => {
            if (e.view.getViewType() === `markdown`) {
              let t = e.view,
                n = t.file,
                r = t.youtnoteActionEl,
                i = t.youtnoteActionFilePath;
              if (!n || n.extension !== `md`) {
                r &&
                  (r.remove(),
                  (t.youtnoteActionEl = null),
                  (t.youtnoteActionFilePath = null));
                return;
              }
              let a = this.isYoutnoteFileFromCache(n);
              if (i === n.path && r?.isConnected) return;
              (r &&
                (r.remove(),
                (t.youtnoteActionEl = null),
                (t.youtnoteActionFilePath = null)),
                a &&
                  ((t.youtnoteActionEl = t.addAction(
                    `youtnote`,
                    `Open as youtnote view`,
                    () => {
                      ((this.youtnoteFileModes[e.id ?? n.path] = Ji),
                        this.setYoutnoteView(e));
                    },
                  )),
                  (t.youtnoteActionFilePath = n.path)));
            }
          });
        },
        r = () => {
      ...
      (this.registerEvent(this.app.workspace.on(`layout-change`, r)),
        ...
        this.register(() => {
          t !== null &&
            (activeWindow.cancelAnimationFrame(t), (t = null), (e = !1));
        }),
        ...
        function () {
          var _plugin = this;
          var _origHM = pi.prototype.handleMessage;
          pi.prototype.handleMessage = function (e) {
            if (!this._viewRegistered) {
              try {
                var _leaves = _plugin.app.workspace.getLeavesOfType(Ji);
                for (var _i = 0; _i < _leaves.length; _i++) {
                  var _leaf = _leaves[_i];
                  var _v = _leaf && _leaf.view;
                  if (
                    _v &&
                    this.iframeElement &&
                    _v.contentEl &&
                    _v.contentEl.contains(this.iframeElement)
                  ) {
                    _v._playerAdapterRef = this;
                    this._viewRegistered = true;
                    if (_v._savedSeekSec > 2) {
                      this._postLoadSeekSec = _v._savedSeekSec;
                      this._postLoadSeekRate = _v._savedSeekRate || null;
                    }
                    break;
                  }
                }
          ...
          this.registerEvent(
            this.app.workspace.on("active-leaf-change", function (leaf) {
              var _allLeaves = _plugin.app.workspace.getLeavesOfType(Ji);
              for (var _i = 0; _i < _allLeaves.length; _i++) {
                var _leaf = _allLeaves[_i];
                var _v = _leaf && _leaf.view;
                if (!_v || _leaf === leaf) continue;
                var _a = _v._playerAdapterRef;
                if (!_a) continue;
                var _pos = _a.cachedCurrentTime || 0;
                var _rate = _a.cachedPlaybackRate || 1;
                if (_pos > 2) {
                  _positions.set(_v.activeVideoId, { sec: _pos, rate: _rate });
                  _v._savedSeekSec = _pos;
                  _v._savedSeekRate = _rate;
                  try {
                    if (_v.requestSave) _v.requestSave();
                  } catch (_e) {}
                }
              }
              if (
                ...
                leaf.view.getViewType() === Ji
              ) {
                var _v = leaf.view;
                var _mem = _positions.get(_v.activeVideoId);
                if (_mem && _mem.sec > 2) {
                  _v._savedSeekSec = _mem.sec;
                  _v._savedSeekRate = _mem.rate;
                  var _a = _v._playerAdapterRef;
                  if (_a && _a.isReady()) {
                    _a.seek(_mem.sec).catch(function () {});
                    if (_mem.rate && _mem.rate !== 1)
                      _a.sendCommand(`setPlaybackRate`, [_mem.rate]);
                  } else if (_a) {
                    _a._postLoadSeekSec = _mem.sec;
                    _a._postLoadSeekRate = _mem.rate;
                  }
                }
              }
            }),
        ...
        (this.didFinishOnload = !0));
    }
    onunload() {
      this.didFinishOnload = !1;
    }
    async loadDataState() {
      let e = (await this.loadData()) ?? {};
      this.settings = Object.assign({}, f, e.settings || {});
    }
    async saveDataState() {
      let e = { settings: this.settings };
      await this.saveData(e);
    }
    isYoutnoteFileFromCache(e) {
      return (
        this.app.metadataCache.getFileCache(e)?.frontmatter?.youtnote === !0
      );
    }
    async isYoutnoteFile(e) {
      return this.isYoutnoteFileFromCache(e)
        ? !0
        : Pi(await this.app.vault.cachedRead(e));
    }
    async setMarkdownView(e) {
      const _s = e.view.getState();
      if (!_s?.file) return;
      await e.setViewState({ type: `markdown`, state: _s, popstate: !0 });
    }
    async setYoutnoteView(e) {
      const _s = e.view.getState();
      if (!_s?.file) return;
      await e.setViewState({ type: Ji, state: _s, popstate: !0 });
    }
    monkeyPatchLeafSetViewState = () => {
      let e = l.WorkspaceLeaf.prototype,
        t = e.setViewState,
        n = e.detach;
      return (
        (l.WorkspaceLeaf.prototype.setViewState = ((e) =>
          function (n, r) {
            if (!e.didFinishOnload) return t.call(this, n, r);
            let i = n.state?.file,
              a = i ? Zi(this, i) : Zi(this);
            if (
              i &&
              i.length > 0 &&
              a &&
              n.type === `markdown` &&
              e.youtnoteFileModes[a] !== `markdown` &&
              e.app.metadataCache.getCache(i)?.frontmatter?.youtnote === !0
            ) {
              let o = { ...n, type: Ji };
              return ((e.youtnoteFileModes[a] = Ji), t.call(this, o, r));
            }
            return t.call(this, n, r);
          })(this)),
        (l.WorkspaceLeaf.prototype.detach = ((e) =>
          function () {
            let t = Xi(this.view?.getState()),
              r = Zi(this, t);
            return (
              r && e.youtnoteFileModes[r] && delete e.youtnoteFileModes[r],
              n.apply(this)
            );
          })(this)),
        () => {
          ((l.WorkspaceLeaf.prototype.setViewState = t),
            (l.WorkspaceLeaf.prototype.detach = n));
        }
      );
    };
    refreshAllViews() {
      this.app.workspace.getLeavesOfType(Ji).forEach((e) => {
        e.view instanceof Yi && e.view.refresh();
      });
    }
  };
// ====================================================================
    ...
    pi.prototype.handleMessage = function (e) {
      if (!this._registeredOnView) {
        try {
          ...
          /* silent — registration will retry on next message */
        }
      }
